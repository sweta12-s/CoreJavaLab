...
class BankAccount
{
	...
	public static void main(String...args){
		...
		Bank1[0]=new BankDetails(1344,"piya",150);
		Bank1[1]=new BankDetails(5667,"Rahul",1500);
		Bank1[2]=new BankDetails(8899,"Priya",800);
		Bank1[3]=new BankDetails(7888,"Pinky",2000);
